<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('roles.index') }}" class="bg-slate-700 text-sm rounded-md text-white px-3 py-2">Go to list</a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.update',$role->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" value="{{ old('name',$role->name) }}" name="name" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Enter name">
                                @error('name')
